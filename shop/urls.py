...
urlpatterns = [
        ...
        path('product_search/<str:basketname>/', views.products.product_search, name='product_search'),
        ...
        path('basket_success/<str:basketname>/', views.customer.basket_success, name='basket_success'),
]